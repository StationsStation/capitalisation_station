...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x14asset_bridging.proto\x12%aea.zarathustra.asset_bridging.v0_1_0"\xd7\r\n\x14AssetBridgingMessage\x12o\n\rbridge_status\x18\x05 \x01(\x0b2V.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.Bridge_Status_PerformativeH\x00\x12_\n\x05error\x18\x06 \x01(\x0b2N.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.Error_PerformativeH\x00\x12q\n\x0erequest_bridge\x18\x07 \x01(\x0b2W.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.Request_Bridge_PerformativeH\x00\x12q\n\x0erequest_status\x18\x08 \x01(\x0b2W.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.Request_Status_PerformativeH\x00\x1a\xc1\x01\n\rBridgeRequest\x12\x14\n\x0csource_chain\x18\x01 \x01(\t\x12\x14\n\x0ctarget_chain\x18\x02 \x01(\t\x12\x14\n\x0csource_token\x18\x03 \x01(\t\x12\x19\n\x0ctarget_token\x18\x04 \x01(\tH\x00\x88\x01\x01\x12\x0e\n\x06amount\x18\x05 \x01(\x02\x12\x0e\n\x06bridge\x18\x06 \x01(\t\x12\x15\n\x08receiver\x18\x07 \x01(\tH\x01\x88\x01\x01B\x0f\n\r_target_tokenB\x0b\n\t_receiver\x1a\xd2\x02\n\x0cBridgeResult\x12\x0f\n\x07tx_hash\x18\x01 \x01(\t\x12e\n\x06status\x18\x02 \x01(\x0e2U.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.BridgeResult.BridgeStatus\x12Z\n\x07request\x18\x03 \x01(\x0b2I.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.BridgeRequest"n\n\x0cBridgeStatus\x12\n\n\x06FAILED\x10\x00\x12\r\n\tCOMPLETED\x10\x01\x12\x16\n\x12PENDING_TX_RECEIPT\x10\x02\x12\x1c\n\x18AWAITING_TARGET_FINALITY\x10\x03\x12\r\n\tCLAIMABLE\x10\x04\x1a\x86\x02\n\tErrorInfo\x12X\n\x04code\x18\x01 \x01(\x0e2J.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.ErrorInfo.Code\x12\x0f\n\x07message\x18\x02 \x01(\t"\x8d\x01\n\x04Code\x12\x18\n\x14INVALID_PERFORMATIVE\x10\x00\x12\x14\n\x10CONNECTION_ERROR\x10\x01\x12\x11\n\rINVALID_ROUTE\x10\x02\x12\x16\n\x12INVALID_PARAMETERS\x10\x03\x12\x15\n\x11ALREADY_FINALIZED\x10\x04\x12\x13\n\x0fOTHER_EXCEPTION\x10\x05\x1ay\n\x1bRequest_Bridge_Performative\x12Z\n\x07request\x18\x01 \x01(\x0b2I.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.BridgeRequest\x1av\n\x1aBridge_Status_Performative\x12X\n\x06result\x18\x01 \x01(\x0b2H.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.BridgeResult\x1aw\n\x1bRequest_Status_Performative\x12X\n\x06result\x18\x01 \x01(\x0b2H.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.BridgeResult\x1ai\n\x12Error_Performative\x12S\n\x04info\x18\x01 \x01(\x0b2E.aea.zarathustra.asset_bridging.v0_1_0.AssetBridgingMessage.ErrorInfoB\x0e\n\x0cperformativeb\x06proto3')
_globals = globals()
