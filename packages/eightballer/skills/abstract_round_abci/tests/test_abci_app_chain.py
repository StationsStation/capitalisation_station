...
from packages.eightballer.skills.abstract_round_abci.abci_app_chain import (
...
class TestAbciAppChaining:
    ...
    def setup(self) -> None:
        ...
        class AbciApp3(AbciApp):
            ...
            db_pre_conditions: dict[AppState, set[str]] = {self.round_3a: {self.key_1, self.key_2}}
    ...
    def test_chain_two(self) -> None:
        ...
        ComposedAbciApp = chain((self.app1_class, self.app2_class), abci_app_transition_mapping)
        ...
        assert ComposedAbciApp.cross_period_persisted_keys == self.cross_period_persisted_keys_1.union(
    ...
    def test_chain_two_negative_timeouts(self) -> None:
        ...
        with pytest.raises(ValueError, match="but it is already defined in a prior app with timeout"):
            _ = chain((self.app1_class, self.app2_class_faulty1), abci_app_transition_mapping)
    ...
    def test_synchronized_data_type(self, caplog: LogCaptureFixture) -> None:
        ...
        for round_ in sorted(abci_app.get_all_rounds(), key=str):
            ...
            expected_cls = (sync_data_cls_app1, sync_data_cls_app2)[round_ in app2_classes]
