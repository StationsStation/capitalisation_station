...
from packages.eightballer.skills.abstract_round_abci.models import Requests
...
from packages.eightballer.skills.abstract_round_abci.test_tools.integration import (
    IntegrationBaseCase,
)
...
def simulate_ledger_get_balance_request(test_instance: IntegrationBaseCase) -> None:
    ...
    cast(Requests, current_behaviour.context.requests).request_id_to_callback[request_nonce] = (
...
class TestIntegrationBaseCase(FSMBehaviourTestToolSetup):
    ...
    def test_instantiation(self) -> None:
        ...
        assert test_instance.process_n_messages(ncycles=0) == ()
