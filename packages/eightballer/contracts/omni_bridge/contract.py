...
class OmniBridge(Contract):
    ...
    @classmethod
    def interest_implementation(cls, ledger_api: LedgerApi, contract_address: str, token: Address) -> JSONLike:
        """Handler method for the 'interest_implementation' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        result = instance.functions.interestImplementation(_token=token).call()
        return {"address": result}
    ...
    @classmethod
    def min_cash_threshold(cls, ledger_api: LedgerApi, contract_address: str, token: Address) -> JSONLike:
        """Handler method for the 'min_cash_threshold' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        result = instance.functions.minCashThreshold(_token=token).call()
        return {"int": result}
    ...
    @classmethod
    def request_gas_limit(
        cls,
        ledger_api: LedgerApi,
        contract_address: str,
    ) -> JSONLike:
        """Handler method for the 'request_gas_limit' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        result = instance.functions.requestGasLimit().call()
        return {"int": result}
    ...
    @classmethod
    def disable_interest(cls, ledger_api: LedgerApi, contract_address: str, token: Address) -> JSONLike:
        """Handler method for the 'disable_interest' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.disableInterest(_token=token)
    ...
    def initialize(
        ...
        return instance.functions.initialize(
            ...
            _requestGasLimit=request_gas_limit,
            _owner=owner,
    ...
    def initialize_interest(
        cls, ledger_api: LedgerApi, contract_address: str, token: Address, impl: Address, min_cash_threshold: int
    ) -> JSONLike:
        """Handler method for the 'initialize_interest' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.initializeInterest(_token=token, _impl=impl, _minCashThreshold=min_cash_threshold)

    @classmethod
    def invest(cls, ledger_api: LedgerApi, contract_address: str, token: Address) -> JSONLike:
        """Handler method for the 'invest' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.invest(_token=token)

    @classmethod
    def migrate_to_3_3_0(
        cls, ledger_api: LedgerApi, contract_address: str, token_factory: Address, interest_implementation: Address
    ) -> JSONLike:
        """Handler method for the 'migrate_to_3_3_0' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.migrateTo_3_3_0(
            _tokenFactory=token_factory, _interestImplementation=interest_implementation
        )
    ...
    def relay_tokens_1(
        ...
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.relayTokens(token=token, _receiver=receiver, _value=value)
    ...
    @classmethod
    def set_min_cash_threshold(
        cls, ledger_api: LedgerApi, contract_address: str, token: Address, min_cash_threshold: int
    ) -> JSONLike:
        """Handler method for the 'set_min_cash_threshold' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.setMinCashThreshold(_token=token, _minCashThreshold=min_cash_threshold)
    ...
    @classmethod
    def set_request_gas_limit(cls, ledger_api: LedgerApi, contract_address: str, gas_limit: int) -> JSONLike:
        """Handler method for the 'set_request_gas_limit' requests."""
        instance = cls.get_instance(ledger_api, contract_address)
        return instance.functions.setRequestGasLimit(_gasLimit=gas_limit)
