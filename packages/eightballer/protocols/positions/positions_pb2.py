...
_POSITIONSMESSAGE_POSITION_POSITION = _POSITIONSMESSAGE_POSITION.nested_types_by_name[
    "Position"
]
...
_POSITIONSMESSAGE_POSITIONS_POSITIONS = (
    _POSITIONSMESSAGE_POSITIONS.nested_types_by_name["Positions"]
)
_POSITIONSMESSAGE_GET_ALL_POSITIONS_PERFORMATIVE = (
    _POSITIONSMESSAGE.nested_types_by_name["Get_All_Positions_Performative"]
)
...
_POSITIONSMESSAGE_GET_POSITION_PERFORMATIVE = _POSITIONSMESSAGE.nested_types_by_name[
    "Get_Position_Performative"
]
_POSITIONSMESSAGE_ALL_POSITIONS_PERFORMATIVE = _POSITIONSMESSAGE.nested_types_by_name[
    "All_Positions_Performative"
]
_POSITIONSMESSAGE_POSITION_PERFORMATIVE = _POSITIONSMESSAGE.nested_types_by_name[
    "Position_Performative"
]
_POSITIONSMESSAGE_ERROR_PERFORMATIVE = _POSITIONSMESSAGE.nested_types_by_name[
    "Error_Performative"
]
_POSITIONSMESSAGE_ERROR_PERFORMATIVE_ERRORDATAENTRY = (
    _POSITIONSMESSAGE_ERROR_PERFORMATIVE.nested_types_by_name["ErrorDataEntry"]
)
_POSITIONSMESSAGE_ERRORCODE_ERRORCODEENUM = (
    _POSITIONSMESSAGE_ERRORCODE.enum_types_by_name["ErrorCodeEnum"]
)
_POSITIONSMESSAGE_POSITIONSIDE_POSITIONSIDEENUM = (
    _POSITIONSMESSAGE_POSITIONSIDE.enum_types_by_name["PositionSideEnum"]
)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _POSITIONSMESSAGE_GET_ALL_POSITIONS_PERFORMATIVE_PARAMSENTRY._serialized_options = (
        b"8\001"
    )
    ...
    _POSITIONSMESSAGE_GET_ALL_POSITIONS_PERFORMATIVE_PARAMSENTRY._serialized_start = (
        1993
    )
