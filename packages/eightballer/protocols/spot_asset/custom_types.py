...
class Decimal:
    ...
    def __init__(self, value, base=DEFAULT_BASE):
        self.value = value
        self.base = base
    ...
    @staticmethod
    def encode(decimal_protobuf_object, decimal_object: "Decimal") -> None:
        """
        Encode an instance of this class into the protocol buffer object.

        The protocol buffer object in the decimal_protobuf_object argument is matched with the instance of this class in the 'decimal_object' argument.

        :param decimal_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :param decimal_object: an instance of this class to be encoded in the protocol buffer object.
        """
        decimal_protobuf_object.Display = str(decimal_object)
        decimal_protobuf_object.Float = decimal_object

    @classmethod
    def decode(cls, decimal_protobuf_object) -> float:
        """
        Decode a protocol buffer object that corresponds with this class into an instance of this class.

        A new instance of this class is created that matches the protocol buffer object in the 'decimal_protobuf_object' argument.

        :param decimal_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :return: A new instance of this class that matches the protocol buffer object in the 'decimal_protobuf_object' argument.
        """
        return float(decimal_protobuf_object.Display)
